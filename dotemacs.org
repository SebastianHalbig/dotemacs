...
We will now set up some magit to transform math expressions into something more readable.
...
(defun latex-symbols-prettify ()
  ...
  (mapc (lambda (pair) (add-to-list 'prettify-symbols-alist pair))
        ;; ARROWS
        '(
          ;; ("\\to"                 ? (Bl Bl 0 -15) ?⎻  (Br Bc 30 -15) ?⎻ (Br  Bl -62 -19) ?˃ )
          ;; ("\\rightarrow"         ? (Bl Bl 0 -15) ?⎻  (Br Bc 30 -15) ?⎻ (Br  Bl -62 -19) ?˃ )
          ;; ("\\mapsto"             ? (Bl Bl 10 72) ?ࢎ (Bc Bl 0 -15) ?⎻  (Br Bc -25 -15) ?⎻ (Br  Bl -62 -19) ?˃)
          ;; ("\\longmapsto"          ? (Bl Bl 10 72) ?ࢎ (Bc Bl 0 -15) ?⎻  (Br Bc -25 -15) ?⎻ (Br  Bl -62 -19) ?˃)
          ;; ("\\inj"                ? (Bl Bl 10 0) ?ᒼ (Bc Bl -20 -15) ?⎻  (Br Bc 0 -15) ?⎻ (Br  Bl -62 -19) ?˃ )
          ;; ("\\emb"                ? (Bl Bl 10 0) ?ᒼ (Bc Bl -20 -15) ?⎻  (Br Bc 0 -15) ?⎻ (Br  Bl -62 -19) ?˃ )
          ;; ("\\hookrightarrow"     ? (Bl Bl 0 -15) ?⎻ (Br Bl -82 -15) ?⎻ (Br  Bl -62 -19) ?˃ (Br  Bl -20 -19) ?˃)
          ;; ("\\surj"               ? (Bl Bl 0 -15) ?⎻ (Br Bl -82 -15) ?⎻ (Br  Bl -62 -19) ?˃ (Br  Bl -20 -19) ?˃)
          ;; ("\\proj"               ? (Bl Bl 0 -15) ?⎻ (Br Bl -82 -15) ?⎻ (Br  Bl -62 -19) ?˃ (Br  Bl -20 -19) ?˃)
          ;; ("\\twoheadrightarrow"  ? (Bl Bl 0 -15) ?⎻ (Br Bl -82 -15) ?⎻ (Br  Bl -62 -19) ?˃ (Br  Bl -20 -19) ?˃)
          ;; ("\\twoheadleftarrow"    ? (Bl Bl 0 -20) ?˂ (Br Bl -60 -20) ?˂ (Br Bc -5 -15) ?⎻ (Br Bc -27 -15) ?⎻ )
          ;; ;; Up until here
          ;; ("\\longrightarrow"      ? (Bl Bl 0 -15) ?⎻ (Br Bl 0 -15) ?⎻ (Br Bl -20 -15) ?⎻ (Br  Bl -62 -19) ?˃)
...
*** Editing and Autocompletion :INACTIVE:
...
(use-package biblio-zbmath
  :ensure (biblio-zbmath :repo "~/.emacs.d/straight/repos/biblio-zbmath")
  )
#+end_src
**** Zotra
