...
* Fundamental and early settings
...
** Default input method and multilingual environments
...
(use-package consult
  ...
  :bind (("C-x C-r" . consult-recent-file)
         ...
         ("C-c h"   . consult-history)
         ("C-f"     . consult-line)
         :map ergoemacs--emacs-command-emulation-map
         ("C-a" . nil))
  :config
...
(use-package ergoemacs-mode
    ...
    (setq initial-scratch-message ""))    ; Why is this needed?!?
#+end_src

** Marginalia :INACTIVE:TEST:
...
(use-package orderless
  ...
  :custom-face
  (orderless-match-face-0 ((t (:foreground "black" :background nil))))
