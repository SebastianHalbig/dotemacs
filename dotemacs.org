...
Change of standard bindings are saved in _ergoemacs-override-keymap_.
#+begin_src emacs-lisp
...
*** Prelude: A thin (bottom) modeline
 We will have a status line at the top of the frames and therefore disable the modeline at the bottom.
...
(setq package-list
      '(all-the-icons       ; ICONS
        ...
        oauth               ; Oauth library
        biblio              ; Handling bibliographies.
        ...
        ;; corfu            ; Completion Overlay Region FUnction.
          ...
          company-auctex
          company-reftex
        powerthesaurus      ; Because you can't know enough words.
        jeison              ; Dependency of powertheaurus
        ...
        elfeed-score        ; A scoring tool for elfeed
