...
We use the main branch of org. Due to the high dependence of other packages on org, one needs to load it as soon as possible. The real configuration of org is in the section called "[[Org mode][Org mode]]".
However we can reference it using [[https://orgmode.org/manual/Noweb-Reference-Syntax.html][noweb]] syntax.
...
To switch between input methods use [[toggle-input-method]] which is bound to "C-\".
...
It could use a lot(!) of work to optimise embark.
#+begin_src emacs-lisp
(use-package embark
  :bind (("C-." . embark-act)
...
#+end_src
** YASnippet
We use [[https://github.com/joaotavora/yasnippet][yasnippet]] in Latex mode.
#+begin_quote
...
(setq-default org-directory "~/Documents/org-files"
              ...
              org-emphasis-alist
                '(("*" bold)
                  ...
                  ("-" (:strike-through t))
                  ("+" (:box t)))
                org-export-with-broken-links t)            ; Allow export of broken links
#+end_src
...
(use-package org-modern
  ...
  org-modern-todo-faces
              '(("TODO"        :background "#fdf096" :weight semi-bold) ;;straw-yellow
                ("NEXT"        :background "#d65848" :weight bold)      ;;aurora-red
                ("DONE"        :background "#97b578" :weight semi-bold) ;;emerald-green
...
#+begin_src emacs-lisp
(defvar org-theme-css-dir "~/.emacs.org/org-css/") ; location of the css files
#+end_src
...
(defun my-org-current-html-theme ()
  "Retrive the css-file for org export."
  (interactive)
