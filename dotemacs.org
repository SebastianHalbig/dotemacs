...
** Lambda theme
*** TODO [0/1] Prelude: A thin (bottom) modeline
- [ ] Change the font to the same as the top modeline
We define a thin modeline
...
(defun my-thin-modeline ()
  ...
  (set-face-attribute 'mode-line nil
                      :box nil
                      :inherit nil
                      :foreground (my-face-background 'lambda-faint)
                      :background (my-face-background 'lambda-faint)
                      :height 0.1)
...
(use-package lambda-themes
  ...
  :bind ("<f6>" . lambda-themes-toggle-theme)
  :custom-face
  :config
...
(use-package lambda-line
  ...
  (lambda-line-prefix-padding +.5) ;; no extra space for prefix
