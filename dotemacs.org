...
(setq almost-black '"#111A3A"
      almost-white '"#FBFAFC"
      almost-blue  '"#4F5565")

#+end_src

We define a faded version of the nano-light-theme.
...
(defun my-nano-light-muted ()
  ...
  (set-face-attribute 'nano-salient    nil :foreground muted-indigo)
  (set-face-attribute 'nano-salient-i  nil :background muted-indigo)
  (set-face-attribute 'nano-faded      nil :foreground vibrant-gray)
  (set-face-attribute 'nano-faded-i    nil :foreground vibrant-gray)
  (set-face-attribute 'nano-subtle     nil :background pale-gray)
  (set-face-attribute 'nano-subtle-i   nil :foreground pale-gray))
...
(defun my-nano-dark-muted ()
  ...
  (set-face-attribute 'nano-faded-i    nil :foreground pale-blue)
...
Writing long LaTeX documents is painful. In the following, we define some faces that make the interface more readable.
...
;; (defface serif-font
;;     '((t :(:family "Helvetica-Narrow"
;;          :height 140
;;          :weight light)))
;;   "Basic face for long texts."
;;   :group 'basic-faces)
