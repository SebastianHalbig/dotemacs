...
(use-package consult-eglot
  :elpaca (:type git :host github :repo "mohkale/consult-eglot/"))
#+end_src
...
(use-package auctex-latexmk
  :elpaca (:type git :host github :repo "feng-li/auctex-latexmk")
  :after auctex
  :config
...
(use-package math-delimiters
  :elpaca (:url "https://github.com/oantolin/math-delimiters")
  :ensure auctex
...
(use-package latex-change-env
  :elpaca (:type git :host github :repo "slotThe/change-env")
  :ensure auctex
  :demand t
  :init
  :bind (:map LaTeX-mode-map
...
(use-package biblio-zbmath
  :elpaca (biblio-zbmath :repo "~/.emacs.d/straight/repos/biblio-zbmath")
  )
#+end_src
**** Zotra
...
#+begin_src emacs-lisp
(use-package jinx
  :elpaca (:type git :host github :repo "minad/jinx")
  :after vertico
  :init
...
(use-package dashboard
  :elpaca (:type git :host github :repo "emacs-dashboard/emacs-dashboard")
  :ensure t
  :config
...
#+begin_src emacs-lisp
(use-package maxima
  :elpaca (maxima :type git :flavor melpa :files ("maxima.el" "maxima-font-lock.el" ("keywords" "keywords/*") "maxima-pkg.el") :host gitlab :repo   "sasanidas/maxima")
...
(use-package visual-regexp
  :elpaca (:host github :repo "benma/visual-regexp.el")
  :bind (:map ergoemacs-override-keymap
...
(use-package gptel
  :elpaca (:host github :repo "karthink/gptel"))
