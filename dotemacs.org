...
We bind mu4e to M-m.
#+begin_src emacs-lisp
(bind-key (kbd "M-m") #'mu4e 'ergoemacs-override-keymap)
#+end_src
...
(defvar mu4e-tag-history '("RESEARCH" "TEACHING" "ORGANISATIONAL" "INFO" "INVOICE")
  "Mu4e tag history list.")

(add-to-list 'savehist-additional-variables 'mu4e-tag-history)

(put 'mu4e-tag-history 'history-length 5)
...
(use-package magit
  ...
  :config
  (visual-line-mode 1)
  (setq magit-branch-direct-configure nil)) ;;use the standard branch config
#+end_src
